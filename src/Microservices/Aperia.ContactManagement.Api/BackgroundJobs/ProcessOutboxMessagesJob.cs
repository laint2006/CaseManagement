...
public class ProcessOutboxMessagesJob : IJob
{
    ...
    /// </summary>
    private readonly ContactManagementContext _dbContext;
    ...
    public ProcessOutboxMessagesJob(IAppContext appContext, IDateTimeProvider dateTimeProvider, ContactManagementContext dbContext, IEventPublisher publisher)
    {
